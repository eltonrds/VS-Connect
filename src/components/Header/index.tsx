        ...
        <div>
            ...
            <header>
                <div className="container header_conteudo">
                    <a className="menu_barras" id="menu_barras" aria-label="abrir menu" aria-expanded="false" aria-controls="menu_links" onClick={mostrarMenu} aria-haspopup="true" href="#"><div className="barras"></div></a>
